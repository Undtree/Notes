...
> 这里我们只介绍上面提到的高级通信的几种方式，关于信号量的介绍请看[同步]()这一节的有关内容。
...
> 有关生产者-消费者模式，请看[同步]()这一节的有关内容。

<figure markdown>
![管道通信示意图](../../images/OS/pipe.svg){:width="80%"}
</figure>
...
<figure markdown>
![三种多线程模型：一对一、多对多和多对一；虚线分隔用户空间与内核空间](../../images/OS/thread_models.svg){:width="80%"}
</figure>
